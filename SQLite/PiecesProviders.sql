Reference: https://en.wikibooks.org/wiki/SQL_Exercises/Pieces_and_providers
...
SELECT Provides.Price, Pieces.Name, Providers.Name
FROM Provides INNER JOIN Pieces
